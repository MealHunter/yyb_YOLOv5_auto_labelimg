...
def get_start_index(output_dir):
    ...
    max_index = 145  # 设定最小起始编号
    pattern = re.compile(r"chair_(\d{4})\.png")
...
def extract_frames_and_remove_green_boxes(video_path, output_dir):
    ...
    while True:
        ...
        # 保存处理后的帧
        output_path = os.path.join(output_dir, f"chair_{start_index:04d}.png")
...
if __name__ == "__main__":
    # 设置视频路径和输出目录
    video_path = "D:/SourceFile/WXWork/1688857496710088/Cache/Video/2025-03/video(10).mp4"  # 替换为你的视频路径
    output_dir = "C:/Users/admin/Desktop/2025-3-17/images"  # 替换为你的输出目录
